...
class StackBottomSheetTest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _bottomSheetBody = ListView(
      ...
      children: <Widget>[
        RaisedButton(
          onPressed: () {
            _stackBottomSheetController.close({'name': 'lili', 'age': 18});
          },
          child: Text('close stackBottomSheet'),
        ),
        Container(
          color: Colors.yellow,
          height: 200.0,
    ...
    Widget _body = ListView(
      children: <Widget>[
        RaisedButton(
          onPressed: () {
            _stackBottomSheetController.show({'name': 'lili', 'age': 18});
          },
          child: Text('show StackBottomSheet'),
        ),
        Image.network(
